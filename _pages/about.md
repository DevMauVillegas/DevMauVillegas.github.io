...
The training was short, only a quarter long, but in that time I master C++ and started creating dumb games with SFML to be as close as possible to the code. The project is still visible in the gitlab repository [HERE](https://gitlab.com/dev-mau-villegas/car-shooter){: target="_blank" rel="noopener noreferrer" }. Is painfully old and probably terrible, but it used to work and it was the first attempt of making a videogame with code.
